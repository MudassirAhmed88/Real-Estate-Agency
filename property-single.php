          ...
          <div class="col-md-12 col-lg-4">
            <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                  <a href="allproperty.php">Properties</a>
                </li>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="property-agent">
                  <h4 class="title-agent">Yasir Shahzad</h4>
                  <p class="color-text-a">
                   MY Estate Agency provide Online Support for the User to sell and Buy his property. When a user want's to buy or take the on Rent he will contact us. We will provide the best property with mininium time.
                  </p>
                  <ul class="list-unstyled">
                    <li class="d-flex justify-content-between">
                      <strong>Mobile:</strong>
                      <span class="color-text-a">+92 347 0982480</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Email:</strong>
                      <span class="color-text-a">Yasir824@gmail.com</span>
                    </li>
                    <li class="d-flex justify-content-between">
                      <strong>Location:</strong>
                      <span class="color-text-a">Sabar Abad Karak.</span>
                    </li>
                  </ul>
                  <div class="socials-a">
