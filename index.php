      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="images/mudassir.jpg" alt="Agent One" height="400px;">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
                    <h3 class="title-d">
                      <a href="#" class="link-two"> Mudassir Ahmed Khattak
                        <br> Owner</a>
                    </h3>
                  </div>
                </div>
                <div class="card-body-d">
                  ...
                  <div class="info-agents color-a">
                    <p>
                      <strong>Phone: </strong> +92 348 9897145</p>
                    <p>
                      <strong>Email: </strong>  mudassirahmed88@yahoo.com</p>
                  </div>
                </div>
          ...
          <div class="col-md-6">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="images/mussadiq.jpg" alt="Second Agent" height="400px">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
