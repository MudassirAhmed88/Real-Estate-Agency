<?php
	...
	if(isset($_POST['update']))
    {
        ...
        {
            $sql = "UPDATE `flats` SET `area`='$area',`price`='$price',`status`='$status',`pic`='$pic',`pic2`='$pic2',`location`='$location',`discription`='$discription',`rooms`='$rooms',`bathrooms`='$bathrooms',`garage`='$garage',`kitchan`='$kitchan' WHERE `id`='$id'";
						...
						<div class="row mb-2">
						  ...
						  <div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
							  ...
							  <li class="breadcrumb-item"><a href="Flats.php"> FLAT </a></li>
							...
							<?php echo $msg; ?>
								<form method="POST" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="form-group col-sm-6">
											<label> Rooms</label>
											<input type="text" name="rooms" maxlength="4" onkeyup="stopcursor(this)" value="<?php echo $result1['rooms'];?>" placeholder="Total Rooms, If No Than enter 0..." class="form-control" required />
										<?php echo $msg12;?>
										</div>
										<div class="form-group col-sm-6">
											<label> Bathrooms </label>
											<input type="text" name="bathrooms" value="<?php echo $result1['bathrooms'];?>" placeholder="Total Bathrooms, If No Than enter 0" maxlength="4" class="form-control" required />
											<?php echo $msg13; ?>
										</div>
									</div>
									<div class="row">
										<div class="form-group col-sm-6">
											<label> Garage </label>
											<input type="text" name="garage" maxlength="4" value="<?php echo $result1['garage'];?>" placeholder="Total Garages, If No Than enter 0..." class="form-control" required />
											<?php echo $msg14; ?>
										</div>
										<div class="form-group col-sm-6">
											<label> Kitchan </label>
											<input type="text" name="kitchan" maxlength="4" value="<?php echo $result1['kitchan'];?>" placeholder="Total Kitchan, If No Than enter 0..." class="form-control" required />
											<?php echo $msg15; ?>
										</div>
									</div>
									<div class="row">
