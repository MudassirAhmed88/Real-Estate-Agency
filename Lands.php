				...
				<!-- Content Header (Page header) -->
					<div class="content-header">
					  <div class="container-fluid">
						<div class="row mb-2">
						  <div class="col-sm-6">
							<h1 class="m-0 text-dark">All Lands</h1>
						  </div><!-- /.col -->
						  <div class="col-sm-6">
                                        ...
                                        <tbody>
											...
											?>
														<tr>
															...
															<td>
															  <a href="land details.php?l_id=<?php echo $data['id'];?>" class="btn btn-xs btn-success editbtn"><span class="fa fa-info"></span>  </a>
															</td>
														</tr>
											<?php 
													}
